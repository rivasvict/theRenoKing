...
public class BarChart extends XYChart {
  ...
  private int []  barChartColors = new int[] { Color.GREEN, Color.YELLOW, 0xffEF9D0A, 0xffF26B0D, 0xffADE014, 0xffF10C0C,
      Color.MAGENTA, Color.RED, Color.WHITE, Color.YELLOW, Color.GREEN, Color.BLUE, Color.GREEN, Color.BLUE};
  ...
  public void drawSeries(Canvas canvas, Paint paint, List<Float> points,
    ...
    float halfDiffX = getHalfDiffX(points, length, seriesNr);
    for (int i = 0; i < length; i += 2) {
      int colorIndex = (int) ( i / 2 ) % barChartColors.length;
